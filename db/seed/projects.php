<?php
/**
 * Ornek site kayitlari.  DOCS.md 4.7, 9.4
 *
 * Bolum 4.7: her ilce sayfasi o ilceye ait EN AZ BIR ornek site kaydi
 ...
 *
 * Bu kayitlar teslim edilmis musteri isi DEGILDIR; yapabildiklerimizi
 * gosteren ornek kurgulardir. On yuzde `projects_notice` ayarindaki not
 * bunu ziyaretciye acikca soyler. Gercek isler yayina girdikce buraya
 * eklenir ve o zaman not bosaltilir (bolum 17).
 */
...
return [
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Doluluğunun tamamını platformlardan sağlayan '
            . 'bir pansiyon, komisyon yükünü azaltmak istiyor.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Müsaitlik takvimi ve dönem bazlı fiyatlandırma</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Üye üreticilerin ürününü kendi markasıyla '
            . 'satmak isteyen bir kooperatif.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Litre ve kilogram varyantlarıyla stok takibi</li>'
            . '<li>Hasat dönemi on siparişi ve bekleme listesi</li>'
            . '<li>Bölgeye göre kargo ücreti</li><li>Üretici tanıtım sayfaları</li></ul>',
    ],
    [
        'client' => 'Örnek Diş Polikliniği', 'sector' => 'Sağlık', 'district' => 'Edremit',
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Harita sonuçlarında görünen ama sitesi olmadığı '
            . 'için karşılaştırmada geride kalan bir poliklinik.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Her tedavi için ayrı sayfa ve SSS</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Portal bağımlılığını azaltmak isteyen bir '
            . 'emlak ofisi.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Her mahalle için bölge rehberi sayfası</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Yabancı misafir oranı yüksek bir butik otel, '
            . 'otomatik çeviriyle görünür olamıyordu.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Türkçe, İngilizce ve Almanca ayrı içerik</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Sulama ve hasat sezonlarında arama trafiğini '
            . 'yakalamak isteyen bir tarım bayii.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Sezon öncesi yayınlanan ürün sayfaları</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>Sezon dışında boş kalan apart daireler için '
            . 'uzun dönem misafir.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Günlük ve uzun dönem için ayrı sayfalar</li>'
    ...
    [
        ...
        'content' => '<h2>Çözdüğü ihtiyaç</h2><p>İhracat yapan bir üretim firması, teknik '
            . 'bilgiyi karşı tarafa hızlı ulaştırmak istiyor.</p>'
            . '<h2>Örnekteki bölümler</h2><ul><li>Ürün kodu ve kapasite bazlı liste</li>'
